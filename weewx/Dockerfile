...
LABEL \
    ...
    org.opencontainers.image.source="https://github.com/magimat/weewx-ha-addon" \
    org.opencontainers.image.documentation="https://github.com/magimat/weewx-ha-addon/README.md" \
